...
class CUFT_Gravity_Adapter extends Abstract_CUFT_Adapter {
    ...
    public function create_form($template_id, $config = array()) {
        if ($this->silent_exit_if_unavailable()) {
            return $this->error('framework_unavailable', __('Gravity Forms is not available.', 'choice-universal-form-tracker'));
        }
    ...
    private function build_gravity_form_array($instance_id, $template_id) {
        ...
        return array(
            ...
            'button' => array(
                'type' => 'text',
                'text' => __('Submit', 'choice-universal-form-tracker'),
            ),
            'confirmations' => array(
                array(
                    ...
                    'isDefault' => true,
                    'type' => 'message',
                    'message' => __('Thank you for your submission!', 'choice-universal-form-tracker'),
                ),
            ),
        );
    }
