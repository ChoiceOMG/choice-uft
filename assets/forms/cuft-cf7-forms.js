(function() {
    ...
    var DEBUG = !!(window.cuftCF7 && window.cuftCF7.debug);
    
    function log() {
        try {
            if (DEBUG && window.console && window.console.log) {
                window.console.log.apply(window.console, ['[CUFT CF7]'].concat(Array.prototype.slice.call(arguments)));
            }
        } catch(e) {}
    }
    ...
    function getFieldValue(form, type) {
        ...
        for (var i = 0; i < inputs.length; i++) {
            ...
            if (type === 'email') {
                ...
                if (inputType === 'tel' || name.indexOf('tel') > -1 || name.indexOf('phone') > -1) {
