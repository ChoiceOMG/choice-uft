(function() {
    ...
    var DEBUG = !!(window.cuftGravity && window.cuftGravity.debug);
    
    function log() {
        try {
            if (DEBUG && window.console && window.console.log) {
                window.console.log.apply(window.console, ['[CUFT Gravity]'].concat(Array.prototype.slice.call(arguments)));
            }
        } catch(e) {}
    }
    ...
    function handleFormSubmit(event) {
        try {
            ...
            var isGravityForm = form.classList.contains('gform_form') ||
